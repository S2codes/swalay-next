...
const LabelActivationForm = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 to-purple-500 p-4">
      <div className="bg-white p-8 md:p-11 rounded-lg shadow-xl w-full max-w-lg">
        ...
        <form>
          <div className="mb-4">
            ...
            <input 
              ...
              className=" text-gray-600 w-full p-3 border  border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" 
            />
          </div>
          <div className="mb-4">
